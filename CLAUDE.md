...
This project uses the Agentic Dev Stack with specialized agents for different layers:

### 1. Authentication Agent (auth-skill)
**Use for:** All authentication-related functionality
...
- Setting up JWT token issuance and validation
- Adding password security features
- Auditing authentication flows for vulnerabilities

### 2. Frontend Agent (frontend-skill)
...
- Integrating API calls from frontend

### 3. Database Agent (database-skill)
**Use for:** Database design and operations (Neon PostgreSQL)
- Creating table schemas and models
...
**When to invoke:**
- Designing new tables or models
- Creating or modifying migrations
- Optimizing database queries
- Setting up database connections
- Managing schema evolution

### 4. Backend Agent (backend-skill)
**Use for:** FastAPI backend development
- Creating RESTful API endpoints
- Handling request/response validation with Pydantic
- Integrating with SQLModel ORM
...
**Important:** Always use the appropriate specialized agent for its domain. Do not manually code; agents handle implementation.
...
4. Implement via Claude Code (using specialized agents)

**No manual coding allowed.** All development must be done through agents.
...
4. Backend identifies user → Decodes token to get user ID/email and matches with user ID in URL
...
- Backend middleware extracts and verifies JWT tokens
